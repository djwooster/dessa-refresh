...
export default function RatingCompletionPage() {
  return (
    <div className="p-6 space-y-5">
      <div>
        <div className="flex items-center justify-between">
          <ReportSelector currentHref="/reports3/rating-completion" />
        ...
        <p className="text-[13px] text-gray-500 mt-1">
          Track rating completion rates by site, educator, and rating window.
        </p>
      </div>
