...
export default function SummaryComparisonPage() {
  ...
  function handleReset() {
    setSite("All"); setGrade("All"); setGender("All");
    setGroup("Select a custom group"); setWindow("25-26 Mid");
  }
    ...
    <div className="p-6 space-y-5">
      <div>
        <div className="flex items-center justify-between">
          <ReportSelector currentHref="/reports3/summary-comparison" />
        ...
        <p className="text-[13px] text-gray-500 mt-1">
          This report shows a side-by-side summary comparison of ratings completed by educators and students during the same rating window. This report only shows data for students with both educator and student ratings.
        </p>
      </div>
        ...
        <AnimatePresence initial={false}>
          {filtersOpen && (
            <motion.div initial={{ height: 0 }} animate={{ height: "auto" }} exit={{ height: 0 }} transition={{ duration: 0.15, ease: "easeInOut" }} className="overflow-hidden">
              <div className="border-t border-[#e8ecf0] px-5 py-5 space-y-4">
                ...
                <div className="flex items-end gap-4">
                  <div className="w-[calc(33.333%-11px)]">
